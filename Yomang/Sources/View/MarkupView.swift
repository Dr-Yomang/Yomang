    ...
    var body: some View {
        ZStack {
            ...
            ToolbarItem(placement: .navigationBarLeading) {
                HStack {
                    Button(action: { self.pkCntrl.undoDrawing() }) {
                        Image(systemName: "arrow.uturn.backward.circle")
                    }.disabled(self.pkCntrl.drawings.isEmpty)

                    Button(action: { self.pkCntrl.redoDrawing()}) {
                        Image(systemName: "arrow.uturn.forward.circle")
                    }.disabled(self.pkCntrl.redoDrawings.isEmpty)
                }
            }
